...
public class KLSKKBDbAdapter {
    ...
    private static final String TAG = "KLS_KKBDbAdapter";
    private DatabaseHelper mDbHelper;
    private SQLiteDatabase mDb;

    private static final String DATABASE_NAME = "Timedb";
    private static final String SQLITE_TABLE = "tbl_klskkb";
    ...
    public KLSKKBDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }

    public KLSKKBDbAdapter open() throws SQLException {
    ...
    public void insertSomeCountries() {
        ...
        createCountry("ES02","KL Sentral","Kuala Kubu Baru","1100","1157","14MYR");
        createCountry("ES04","KL Sentral","Kuala Kubu Baru","1500","1557","14MYR");
        createCountry("ES06","KL Sentral","Kuala Kubu Baru","2100","2157","14MYR");
