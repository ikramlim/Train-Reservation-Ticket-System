...
public class KLSIPOHCursorAdapterActivity extends Activity {

    private KLSIPOHDbAdapter dbHelper;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new KLSIPOHDbAdapter(this);
        dbHelper.open();
    ...
    private void displayListView() {
        ...
        String[] columns = new String[] {
                KLSIPOHDbAdapter.KEY_TNO,
                KLSIPOHDbAdapter.KEY_FROMW,
                KLSIPOHDbAdapter.KEY_TOW,
                KLSIPOHDbAdapter.KEY_FROMTIME,
                KLSIPOHDbAdapter.KEY_ARRIVALTIME,
                KLSIPOHDbAdapter.KEY_PRICE,
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View view,
               ...
               // Toast.makeText(getApplicationContext(),
                ...
                Intent i = new Intent(KLSIPOHCursorAdapterActivity.this,  Payment_Form.class);
