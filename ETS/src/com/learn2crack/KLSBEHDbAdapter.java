...
public class KLSBEHDbAdapter {
    ...
    private static final String TAG = "KLS_BEHDbAdapter";
    private DatabaseHelper mDbHelper;
    private SQLiteDatabase mDb;

    private static final String DATABASE_NAME = "Timedb";
    private static final String SQLITE_TABLE = "tbl_klsbeh";
    ...
    public KLSBEHDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }

    public KLSBEHDbAdapter open() throws SQLException {
    ...
    public void insertSomeCountries() {
        ...
        createCountry("ES02","KL Sentral","Behrang","1100","1217","16MYR");
        createCountry("ES04","KL Sentral","Behrang","1500","1617","16MYR");
        createCountry("ES06","KL Sentral","Behrang","2100","2217","16MYR");
